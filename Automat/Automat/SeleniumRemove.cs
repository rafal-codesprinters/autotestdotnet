...
namespace SeleniumTests
{
    ...
    public class SeleniumRemove
    {
        ...
        [Test]
        public void TheSeleniumRemoveTest()
        {
            ...
            driver.FindElement(By.Id("post-search-input")).SendKeys("Demo6661");
            ...
            driver.FindElement(By("Trash (58)")).Click();
            driver.FindElement(By.Id("post-search-input")).Clear();
            driver.FindElement(By.Id("post-search-input")).SendKeys("Demo6661");
            driver.FindElement(By.Id("search-submit")).Click();
            driver.FindElement(By.Id("cb-select-all-1")).Click();
