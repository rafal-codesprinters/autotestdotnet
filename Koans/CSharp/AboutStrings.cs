...
namespace DotNetKoans.CSharp
{
    public class AboutStrings : Koan
    {
        ...
        public void VerbatimStringsCanHandleFlexibleQuoting()
        {
            ...
            // Assert.Equal(fill me in, strA.Equals(strB));
...
broken line";
		...
		public void CurrencyDesignatorsCanBeAdded()
		{
            ...
            Assert.Equal("XDR123,456.00", str);
        }
		...
		{
			var str = string.Format("{0:t}", DateTime.Parse("2011-12-16 2:35:02 PM"));
		...
		{
			var str = string.Format("{0:t m}", DateTime.Parse("2011-12-16 2:35:02 PM"));
