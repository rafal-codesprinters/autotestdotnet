...
broken line";
            ...
            var literalString = string.Format("I{0}am a{0}broken line", Environment.NewLine);
        ...
        public void ACrossPlatformWayToHandleLineEndings()
        {
            ...
            var vebatimString = @"I" + Environment.NewLine + @"am a" + Environment.NewLine + @"broken line";
		...
		public void SeperatorsCanBeAdded()
		{
			...
			Assert.Equal(string.Format("123{0}456,00", System.Globalization.NumberFormatInfo.CurrentInfo.NumberGroupSeparator), str);
		}
