...
namespace DotNetKoans.CSharp
{
    public class AboutNil : Koan
    {
        ...
        {
            //Assert.True(typeof(object).IsAssignableFrom(new object().GetType())); //not everything is an object.
            Assert.True(typeof(object).IsAssignableFrom(typeof(System.Array))); //not everything is an object
        }
        ...
        [Koan(5)]
        public void AWayNotToCheckThatAnObjectIsNull() // teraz jest ok
        {
            object obj = null;
            Assert.True(obj == null);
        }
